import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, toRef, isRef, getCurrentInstance, defineAsyncComponent, defineComponent, createElementBlock, h, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { v as defuFn, w as klona, x as defu, y as createDefu, n as hasProtocol, z as isScriptProtocol, q as joinURL, A as withQuery, c as createError$1, B as sanitizeStatusCode, C as getContext, $ as $fetch$1, D as baseURL, E as createHooks, F as executeAsync, b as getHeader, G as toRouteMatcher, H as createRouter$1, f as setCookie, l as destr, I as getRequestHeader, J as isEqual, e as getCookie, K as deleteCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Cl48K6WH.mjs')
  },
  {
    name: "search",
    path: "/search",
    component: () => import('./search-BIvr_xh2.mjs')
  },
  {
    name: "submit",
    path: "/submit",
    component: () => import('./submit-B2NmZgn9.mjs')
  },
  {
    name: "cfp-slug",
    path: "/cfp/:slug()",
    component: () => import('./_slug_-CXV7pAY9.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { "middleware": "admin" },
    component: () => import('./index-BbCZ1GCs.mjs')
  },
  {
    name: "admin-login",
    path: "/admin/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./login-D-wcOrMg.mjs')
  },
  {
    name: "preferences",
    path: "/preferences",
    component: () => import('./preferences-Cqv9wPdI.mjs')
  },
  {
    name: "admin-approved",
    path: "/admin/approved",
    meta: { "middleware": "admin" },
    component: () => import('./approved-D0MVXRQ4.mjs')
  },
  {
    name: "admin-moderation",
    path: "/admin/moderation",
    meta: { "middleware": "admin" },
    component: () => import('./moderation-BLBDnnwG.mjs')
  },
  {
    name: "account-saved-searches",
    path: "/account/saved-searches",
    component: () => import('./saved-searches-CyCXVRqU.mjs')
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-c5Zy2jvK.mjs')
};
...
const LazyIcon = defineAsyncComponent(() => import('./index-mbtfuGJE.mjs').then((n) => n.i).then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-B89VKYu9.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-cyMog8fZ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Dn0x75NY.mjs'));
...
export { _export_sfc as _, useRoute as a, useRouter as b, appConfig as c, useRequestFetch as d, entry$1 as default, defineNuxtRouteMiddleware as e, fetchDefaults as f, get as g, useSupabaseUser as h, useNuxtApp as i, useState as j, useAppConfig as k, looseToNumber as l, mergeConfig as m, navigateTo as n, omit as o, useRuntimeConfig as p, nuxtLinkDefaults as q, resolveRouteObject as r, asyncDataDefaults as s, twMerge as t, useHead as u, createError as v };
