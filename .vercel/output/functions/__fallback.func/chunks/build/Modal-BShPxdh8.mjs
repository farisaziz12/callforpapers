import { defineComponent, resolveComponent, mergeProps, withCtx, createVNode, renderSlot, createBlock, createCommentVNode, openBlock, toRef, computed, ref, h, watchEffect, provide, normalizeClass, inject, watch, getCurrentInstance, Teleport, reactive, Fragment, shallowRef, unref, nextTick, useId, useSSRContext } from 'vue';
import { c as c$1, i as i$1$1, w as w$2, f as f$1, u as u$4, S as S$1, b as w$1$1, P, N as N$3, t as t$2, d as t$2$1, o, e as t$1$1 } from './active-element-history-CTDrs9J_.mjs';
import { s as s$1$1, c as s$2, S, i as i$1, u as u$3, t as t$1, A as A$2, l as l$1, a as i$2, T as T$1, o as o$1, b as o$2, N as N$4 } from './keyboard-v1ubhqOk.mjs';
import { u as useUI } from './Button-PXp5DTfw.mjs';
...
let ue = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(t2, { attrs: n$1, slots: r, expose: l2 }) {
  let o$12 = ref(null);
  l2({ el: o$12, $el: o$12 });
  let i2 = computed(() => i$1$1(o$12)), e2 = ref(false);
  ...
  function H2(u2) {
    ...
    d2 instanceof HTMLElement && d2.dataset.headlessuiFocusGuard !== "true" && (N$2(T2, d2) || (s2.value ? P(o$1(o$12), u$3(f2.value, { [d$2.Forwards]: () => N$3.Next, [d$2.Backwards]: () => N$3.Previous }) | N$3.WrapAround, { relativeTo: u2.target }) : u2.target instanceof HTMLElement && S$1(u2.target)));
  }
  return () => {
...
let W = N$4.RenderStrategy, he = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e2, { emit: t2, attrs: a2, slots: s2, expose: h$1 }) {
  ...
  g(e2.leaveFrom);
  g(e2.leaveTo);
  return provide(N, P2), t$1(computed(() => u$3(i2.value, { ["visible"]: i$2.Open, ["hidden"]: i$2.Closed }) | n2.value)), () => {
  ...
  let h$1 = l$1(), n2 = computed(() => e2.show === null && h$1 !== null ? (h$1.value & i$2.Open) === i$2.Open : e2.show);
  watchEffect(() => {
...
const __nuxt_component_6 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]), { __name: "UModal" });

export { __nuxt_component_6 as _ };
//# sourceMappingURL=Modal-BShPxdh8.mjs.map
